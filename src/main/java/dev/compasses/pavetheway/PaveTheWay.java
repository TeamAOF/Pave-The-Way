...
public class PaveTheWay {
    ...
    private final Lazy<Block> DIRT_PATH_BLOCK = Lazy.of(() -> new DirtPathBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DIRT_PATH).setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(MODID, "dirt_path")))));
    private final Lazy<Item> DIRT_PATH_ITEM = Lazy.of(() -> new BlockItem(DIRT_PATH_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(MODID, "dirt_path")))));
